                        ...
                        <div class="wizard">
                            <div class="wizard-inner">
                                ...
                                <span class="round-tab">
                                    ...
                                    <li role="presentation" class="nav-item">
                                        <a href="" data-toggle="tab" aria-controls="step2" role="tab" title="Step 2" class="nav-link active">
                                <span class="round-tab">
                            ...
                            <div class="tab-content">
                                <div class="panel container center-block col-md-3 col-lg-3" >
                                    ...
                                    {{--</ul>--}}
                                    <div class="panel">
                                        {!! Form::open(['route' => 'addBeneficiaries' ,'files' => true,$TempName]) !!}
